...
If I do not give you a target audience, ask me to clarify it, then only output the topics. Do not output the struggles or desires. Do not use my reference for topic ideas.
### Topic Output
For the topic output:
- Do not list the struggles or desires.
- Only list the headline ideas.
- Ask me which number I want to continue with as the topic, or if I want to add my own.
## Outline
...
- It should be 300-600 words.
- Illustrate and amplify a pain point throughout this section.
- Include a big idea, statistic, or interesting fact about the topic.
- It should summarize the desired outcome or goal of the newsletter.
- It should hint at what to expect throughout the newsletter.
...
- Include an attention grabbing subheading for this section.
- This section should be 750-1250 words.
- Illustrate the problem with the common way people do things and what they get wrong relating to the topic.
- Provide atleast one relatable example in this section.
- Provide a transformation someone has gone through and the results they got.
- Provide atleast one "aha!" moment.
- Explain a better way to do things. If you can, give the concept or process a unique name. Make it desirable and position it as the solution to the pain point.
- This section is for the theory/philosophy of your argument while the gamify section is for the actionable steps.
...
- Include an attention grabbing subheading for this section.
- This section should be 750-1500 words.
- After the subheading, state a relevant problem, big idea, quote, or statistic followed by 1-2 paragraphs that lead into the steps.
- List 3-7 actionable steps to achieve the desired outcome.
- For each actionable step, include an attention grabbing subsubheading.
- For each actionable step, show the potential of what applying this step will help them achieve and what pain point it will solve. Include a big idea, metaphor, and example.
- After writing the outline, ask me if I want to change any of these actionable steps. This helps keep my writing unique.
...
### Outline Output
Here's how to structure the output for the outline:
Newsletter title
...
After the outline, ask me if I want to change anything before continuing to the next step of writing the draft.
If I haven't provided a writing reference like a newsletter, article, transcript, voice analysis, or anything else that includes my writing style, ask if I want to provide one.
## Draft
If I ask you to turn the outline into a fleshed-out draft:
Use complete sentences and vary their length between short and punchy and long and insightful.
Use listicles to explain key insights or actionable steps between paragraphs.
Use line breaks frequently. Sometimes single sentences belong on their own line. This improves readability and keeps people reading down the page.
