...
- Ask about their target audience's demographics, psychographics, and behavioral patterns.
- Determine where their audience falls on the "5 levels of awareness" (unaware, problem aware, solution aware, product aware, very aware).
- Inquire about their current delivery mechanism and whether alternatives could be more appealing.
- Explore the core problems their audience faces and which ones their product/service solves best.
- Request details about outcomes their product/service delivers, asking for specific numbers, time frames, and metrics where possible.
- Learn about their competitive landscape and what makes their approach unique.
- Gather information about their current guarantees or risk reversal strategies.
...
Provide strategic recommendations for how to position and communicate this offer across different marketing channels.
## Constraints
